...
describe('Service Tests', () => {
    ...
    describe('PhotosMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(PhotosMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return PhotosMySuffix', () => {

                let entity: PhotosMySuffix;
                service.find(123).subscribe((_entity: PhotosMySuffix) => {
                    entity = _entity;
                });
