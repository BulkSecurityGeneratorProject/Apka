...
describe('Service Tests', () => {
    ...
    describe('ReservationMySuffix Service', () => {
        ...
        beforeEach(async(() => {
            ...
            service = TestBed.get(ReservationMySuffixService);
        ...
        describe('Service methods', () => {
            ...
            it('should return ReservationMySuffix', () => {

                let entity: ReservationMySuffix;
                service.find(123).subscribe((_entity: ReservationMySuffix) => {
                    entity = _entity;
                });
