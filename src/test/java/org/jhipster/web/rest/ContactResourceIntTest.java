...
import org.jhipster.domain.Contact;
import org.jhipster.repository.ContactRepository;
import org.jhipster.service.ContactService;
import org.jhipster.service.dto.ContactDTO;
import org.jhipster.service.mapper.ContactMapper;
...
public class ContactResourceIntTest {
    ...
    public void createContact() throws Exception {
        ...
        assertThat(testContact.getLocalName()).isEqualTo(DEFAULT_LOCAL_NAME);
        assertThat(testContact.getPhoneNumber()).isEqualTo(DEFAULT_PHONE_NUMBER);
        assertThat(testContact.getEmailAdress()).isEqualTo(DEFAULT_EMAIL_ADRESS);
        assertThat(testContact.getAdress()).isEqualTo(DEFAULT_ADRESS);
    }
    ...
    public void getAllContacts() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].emailAdress").value(hasItem(DEFAULT_EMAIL_ADRESS.toString())))
    ...
    public void getContact() throws Exception {
        ...
        restContactMockMvc.perform(get("/api/contacts/{id}", contact.getId()))
            ...
            .andExpect(jsonPath("$.emailAdress").value(DEFAULT_EMAIL_ADRESS.toString()))
    ...
    public void updateContact() throws Exception {
        ...
        Contact testContact = contactList.get(contactList.size() - 1);
        assertThat(testContact.getLocalName()).isEqualTo(UPDATED_LOCAL_NAME);
        assertThat(testContact.getPhoneNumber()).isEqualTo(UPDATED_PHONE_NUMBER);
        assertThat(testContact.getEmailAdress()).isEqualTo(UPDATED_EMAIL_ADRESS);
        assertThat(testContact.getAdress()).isEqualTo(UPDATED_ADRESS);
    }
